        ...
        <div className="flex items-center gap-3 w-full md:w-auto shrink-0 justify-end">
          ...
          <div className="relative w-full sm:w-48">
            ...
            >
              ...
              <option value="Por captar" className="bg-[#1e2528] text-white">Por captar</option>
        ...
        {isLoading ? (
          ...
          <div className="overflow-x-auto">
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="border-b border-white/5 bg-white/[0.02] text-[8px] sm:text-[10px] md:text-xs font-bold text-gray-400 uppercase tracking-wider">
                  <th className="px-1 py-2 md:px-6 md:py-4.5">Cliente/RIF</th>
                  <th className="px-1 py-2 md:px-6 md:py-4.5 hidden sm:table-cell">Zona</th>
                  <th className="px-1 py-2 md:px-6 md:py-4.5 hidden lg:table-cell">Contacto</th>
                  <th className="px-1 py-2 md:px-6 md:py-4.5">Teléfono</th>
                  <th className="px-1 py-2 md:px-6 md:py-4.5 text-center">Estatus</th>
                  <th className="px-1 py-2 md:px-6 md:py-4.5 text-right">Acciones</th>
                </tr>
              </thead>
                  ...
                  >
                    <td className="px-1 py-2 md:px-6 md:py-4">
                      <div className="flex flex-col max-w-[120px] md:max-w-none">
                        <span className="font-semibold text-white tracking-wide truncate">{cliente.nombre}</span>
                        <span className="text-[9px] md:text-xs text-gray-400 mt-0.5 truncate">{cliente.rif || 'RIF no registrado'}</span>
                      </div>
                    </td>
                    <td className="px-1 py-2 md:px-6 md:py-4 hidden sm:table-cell">
                      <div className="flex flex-col">
                        <span className="text-gray-200 text-[10px] md:text-sm">{cliente.zona}</span>
                        <span className="text-[9px] md:text-xs text-gray-500 truncate max-w-[120px] md:max-w-[200px] mt-0.5" title={cliente.direccion}>
                          {cliente.direccion || 'Sin dirección'}
                        </span>
                      </div>
                    </td>
                    <td className="px-1 py-2 md:px-6 md:py-4 text-gray-200 hidden lg:table-cell">
                      {cliente.contacto_1 || <span className="text-gray-500 italic">No asignado</span>}
                    </td>
                    <td className="px-1 py-2 md:px-6 md:py-4 text-gray-300">
                      <div className="flex flex-col text-[10px] md:text-sm">
                        ...
                        {cliente.telefono_1 && cliente.movil && (
                          <span className="text-[9px] md:text-[11px] text-gray-500 mt-0.5">{cliente.movil}</span>
                        )}
                      </div>
                    </td>
                    <td className="px-1 py-2 md:px-6 md:py-4 text-center">
                      <span className={`inline-block text-[8px] md:text-[10px] font-bold uppercase tracking-wider px-1.5 py-0.5 md:px-2.5 md:py-0.5 rounded border ${
                        cliente.estatus === 'Activo'
                          ? 'bg-cal-emerald/10 text-cal-emerald-light border-cal-emerald/20'
                          : cliente.estatus === 'Inactivo'
                          ? 'bg-red-500/10 text-red-400 border-red-500/20'
                          : cliente.estatus === 'Por captar'
                    ...
                    <td className="px-1 py-2 md:px-6 md:py-4 text-right" onClick={(e) => e.stopPropagation()}>
                      <div className="flex items-center justify-end gap-1 md:gap-2">
                        <button
                          onClick={() => handleOpenEdit(cliente)}
                          title="Editar Cliente"
                          className="p-1.5 md:p-2 bg-white/5 hover:bg-white/10 text-gray-300 hover:text-white rounded-lg md:rounded-xl border border-white/5 hover:border-white/10 transition-all cursor-pointer"
                        >
                        ...
                        <button
                          ...
                          className="p-1.5 md:p-2 bg-white/5 hover:bg-red-500/15 text-gray-400 hover:text-red-400 rounded-lg md:rounded-xl border border-white/5 hover:border-red-500/20 transition-all cursor-pointer"
                        >
              ...
              <div>
                <span className={`inline-block text-[9px] font-extrabold uppercase tracking-widest px-2 py-0.5 rounded-full mb-2 border ${
                  selectedCliente.estatus === 'Activo'
                    ...
                    ? 'bg-red-500/10 text-red-400 border-red-500/20'
                    : selectedCliente.estatus === 'Por captar'
                    ? 'bg-blue-500/10 text-blue-400 border-blue-500/20'
                    : selectedCliente.estatus === 'Prospecto'
                    ? 'bg-amber-500/10 text-amber-400 border-amber-500/20'
                    : 'bg-white/5 text-gray-400 border-white/10'
                }`}>
                  {selectedCliente.estatus || 'Sin Estatus'}
                </span>
